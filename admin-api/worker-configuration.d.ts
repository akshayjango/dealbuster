/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eef9e29eb0a233c923a07893a8e05a5a)
// Runtime types generated with workerd@1.20260918.1 2025-01-01 
interface __BaseEnv_Env {
	KV: KVNamespace;
	ASSETS: Fetcher;
	TELEGRAM_ADMIN_ID: "715667303";
	VAPID_PUBLIC_KEY: "BBpxbJXp8fXx1OG51wAiVjQ-QrWCqDd0eRyA6sxaw0MllG6RyPO-QHQfsig1VScCEdOfrzl6_vNfXuEBDIcBVaY";
	VAPID_SUBJECT: "mailto:contactdealbuster@gmail.com";
	ADMIN_PASSWORD: string;
	VAPID_PRIVATE_KEY_JWK: string;
	SCRAPER_API_KEYS: string;
	TG_POSTER: DurableObjectNamespace<import("./src/index").TgPoster>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TgPoster";
	}
